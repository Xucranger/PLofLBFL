...
# Condefects
# mytitle = '/home/xuhexiang/llmInNoviceProgramFL/CodeArrange/evaluate/rq3/Condefects_prompt_various.pdf'
# top_1 = np.array([23, 21, 21, 19, 18, 26])
# top_3 = np.array([32, 34, 27, 31, 31, 33])
# top_5 = np.array([37, 38, 32, 35, 37, 38])
# Codeflaws
# mytitle = '/home/xuhexiang/llmInNoviceProgramFL/CodeArrange/evaluate/rq3/Codeflaws_prompt_various.pdf'
# top_1 = np.array([9, 11, 12, 14, 14, 13])
# top_3 = np.array([24, 25, 21, 21, 27, 20])
# top_5 = np.array([29, 28, 29, 27, 33, 29])
# # BugT
mytitle = '/home/xuhexiang/llmInNoviceProgramFL/CodeArrange/evaluate/rq3/BugT_prompt_various.pdf'
top_1 = np.array([17, 14, 15, 14, 14, 12])
top_3 = np.array([21, 29, 23, 19, 22, 25])
top_5 = np.array([29, 29, 30, 26, 29, 32])
