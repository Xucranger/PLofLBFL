...
if __name__ == "__main__":
    ...
    # 画BugT
    title = "GPT-4_promots_various_in_Bugt"
    root_path = "/home/xuhexiang/data/BugT/Code"

    all =  analyze_BugT("prompt1-all-gpt4", "gpt-4", 50,root_path)
    noChain = analyze_BugT("prompt1-noChain-gpt4", "gpt-4", 50,root_path)
    noIntent = analyze_BugT("prompt1-noIntent-gpt4", "gpt-4", 50,root_path)
    noNoviceDescription = analyze_BugT("prompt1-noNoviceDescription-gpt4", "gpt-4", 50,root_path)
    noReason = analyze_BugT("prompt1-noReason-gpt4", "gpt-4", 50,root_path)
    noSort = analyze_BugT("prompt1-noSort-gpt4", "gpt-4", 50,root_path)
    ...
    # title = "O1preview_promots_various_in_Bugt"
    # root_path = "/home/xuhexiang/data/BugT/Code"

    # all =  analyze_BugT("prompt1-all", "o1-preview", 50,root_path)
    # noChain = analyze_BugT("prompt1-noChain2", "o1-preview", 50,root_path)
    # noIntent = analyze_BugT("prompt1-noIntent2", "o1-preview", 50,root_path)
    # noNoviceDescription = analyze_BugT("prompt1-noNoviceDescription2", "o1-preview", 50,root_path)
    # noReason = analyze_BugT("prompt1-noReason2", "o1-preview", 50,root_path)
    # noSort = analyze_BugT("prompt1-noSort2", "o1-preview", 50,root_path)
    ...
    # title = "DeepSeekV3_promots_various_in_Bugt"
    # root_path = "/home/xuhexiang/data/BugT/Code"

    # all =  analyze_BugT("prompt1-all", "deepseekV3", 50,root_path)
    # noChain = analyze_BugT("prompt1-noChain2", "deepseekV3", 50,root_path)
    # noIntent = analyze_BugT("prompt1-noIntent2", "deepseekV3", 50,root_path)
    # noNoviceDescription = analyze_BugT("prompt1-noNoviceDescription2", "deepseekV3", 50,root_path)
    # noReason = analyze_BugT("prompt1-noReason2", "deepseekV3", 50,root_path)
    # noSort = analyze_BugT("prompt1-noSort2", "deepseekV3", 50,root_path)
