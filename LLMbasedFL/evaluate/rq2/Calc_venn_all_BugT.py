...
if __name__ == "__main__":
    ...
    # 画BugT上的
    # title = "o1-preview DeepSeekV3 and other technique in TOP-"+str(top_number[index])+" of Condefects"
    root_path = "/home/xuhexiang/data/BugT/Code"
    Condefects_ans_o1preview = analyze_BugT( 6, "o1-preview", 503, root_path)
    Condefects_ans_deepseekV3 = analyze_BugT( 6, "deepseekV3", 503, root_path)
    Condefects_ans_chatGlm4 = analyze_BugT( 1, "chatGlm4", 503, root_path)
    Condefects_ans_llama = analyze_BugT( 1, "llama3", 503, root_path)
    # root_path = "/home/xuhexiang/data_openLLM/ConDefects-main/Code"

    Condefects_ans_codellama = analyze_BugT( 1, "codellama", 503, root_path)
    ...
    Condefects_ans_dstarMBFL = analyze_sbfl_mbfll("dstar", "MBFL", root_path,"BugT")
    Condefects_ans_ochiMBFL = analyze_sbfl_mbfll("ochi", "MBFL", root_path, "BugT")
    Condefects_ans_op2MBFL = analyze_sbfl_mbfll("op", "MBFL", root_path, "BugT")
    Condefects_ans_dstarSBFL = analyze_sbfl_mbfll("dstar", "SBFL", root_path, "BugT")
    Condefects_ans_ochiSBFL = analyze_sbfl_mbfll("ochi", "SBFL", root_path, "BugT")
    Condefects_ans_op2SBFL = analyze_sbfl_mbfll("op", "SBFL", root_path, "BugT")

    # print(ans_o1preview)
    # modelAns(o1preview),chatGlm4
    ...
    # my_colors = [(196 / 255, 216 / 255, 242 / 255),(242 / 255, 232 / 255, 227 / 255), (142 / 255, 45 / 255, 48 / 255),(51 / 255, 57 / 255, 91 / 255), (93 / 255, 116 / 255, 162 / 255),  (90 / 255, 134 / 255, 83 / 255)
    ...
    legend_colors = [(51/255, 57/255, 91/255), 
        (93/255, 116/255, 162/255),  
        (196/255, 216/255, 242/255)  ]
    labels = ['Top1', 'Top3', 'Top5']
