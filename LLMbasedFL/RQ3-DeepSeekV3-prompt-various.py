...
if __name__ == "__main__":
    ...
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-all-dsv3", experiment_model, 50)
    run_Condefects(prompt, "prompt1-all-dsv3", experiment_model, 50)
    run_BugT(prompt, "prompt1-all-dsv3", experiment_model, 50)

    prompt_location = os.path.join(base_location, "prompt1-noChain.txt")
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-noChain-dsv3", experiment_model, 50)
    run_Condefects(prompt, "prompt1-noChain-dsv3", experiment_model, 50)
    run_BugT(prompt, "prompt1-noChain-dsv3", experiment_model, 50)

    prompt_location = os.path.join(base_location, "prompt1-noIntent.txt")
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-noIntent-dsv3", experiment_model, 50)
    run_Condefects(prompt, "prompt1-noIntent-dsv3", experiment_model, 50)
    run_BugT(prompt, "prompt1-noIntent-dsv3", experiment_model, 50)

    prompt_location = os.path.join(base_location, "prompt1-noNoviceDescription.txt")
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-noNoviceDescription-dsv3", experiment_model, 50)
    run_Condefects(prompt, "prompt1-noNoviceDescription-dsv3", experiment_model, 50)
    run_BugT(prompt, "prompt1-noNoviceDescription-dsv3", experiment_model, 50)

    prompt_location = os.path.join(base_location, "prompt1-noReason.txt")
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-noReason-dsv3", experiment_model, 50)
    run_Condefects(prompt, "prompt1-noReason-dsv3", experiment_model, 50)
    run_BugT(prompt, "prompt1-noReason-dsv3", experiment_model, 50)

    prompt_location = os.path.join(base_location, "prompt1-noSort.txt")
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-noSort-dsv3", experiment_model, 50)
    run_Condefects(prompt, "prompt1-noSort-dsv3", experiment_model, 50)
    run_BugT(prompt, "prompt1-noSort-dsv3", experiment_model, 50)
