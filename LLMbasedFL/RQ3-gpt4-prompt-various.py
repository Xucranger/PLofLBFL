...
if __name__ == "__main__":
    ...
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-all-gpt43", experiment_model, 503)
    run_Condefects(prompt, "prompt1-all-gpt43", experiment_model, 503)
    run_BugT(prompt, "prompt1-all-gpt43", experiment_model, 503)

    prompt_location = os.path.join(base_location, "prompt1-noChain.txt")
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-noChain-gpt43", experiment_model, 503)
    run_Condefects(prompt, "prompt1-noChain-gpt43", experiment_model, 503)
    run_BugT(prompt, "prompt1-noChain-gpt43", experiment_model, 503)

    prompt_location = os.path.join(base_location, "prompt1-noIntent.txt")
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-noIntent-gpt43", experiment_model, 503)
    run_Condefects(prompt, "prompt1-noIntent-gpt43", experiment_model, 503)
    run_BugT(prompt, "prompt1-noIntent-gpt43", experiment_model, 503)

    prompt_location = os.path.join(base_location, "prompt1-noNoviceDescription.txt")
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-noNoviceDescription-gpt43", experiment_model, 503)
    run_Condefects(prompt, "prompt1-noNoviceDescription-gpt43", experiment_model, 503)
    run_BugT(prompt, "prompt1-noNoviceDescription-gpt43", experiment_model, 503)

    prompt_location = os.path.join(base_location, "prompt1-noReason.txt")
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-noReason-gpt43", experiment_model, 503)
    run_Condefects(prompt, "prompt1-noReason-gpt43", experiment_model, 503)
    run_BugT(prompt, "prompt1-noReason-gpt43", experiment_model, 503)

    prompt_location = os.path.join(base_location, "prompt1-noSort.txt")
    with open(prompt_location, 'r', encoding='utf-8') as file:
        # 读取文件内容并保存到字符串中
        prompt = file.read()
    run_Codeflaws(prompt, "prompt1-noSort-gpt43", experiment_model, 503)
    run_Condefects(prompt, "prompt1-noSort-gpt43", experiment_model, 503)
    run_BugT(prompt, "prompt1-noSort-gpt43", experiment_model, 503)
