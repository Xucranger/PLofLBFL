...
def send_single_code_faultlocalization(prompt, ans_path,code_location,faultdata,experiment_model):
    ...
    while repeat_time_this>0:
        ...
        #     response_txt = SendPromt.send_prompt_zhipu_form(prompt_code,experiment_model)
        # except:
...
def run_all(prompt):
    ...
    # experiment_model = "chatGlm4"
    experiment_model = "llama2"
    # experiment_model = "codellama"
    # experiment_model = "DeepSeek"
  
    # for i in [1]:
    run_BugT(prompt, 1, experiment_model, 503)
...
if __name__ == "__main__":
    prompt_location = "/home/xuhexiang/llmInNoviceProgramFL/CodeArrange/prompts/prompt1-all.txt"
