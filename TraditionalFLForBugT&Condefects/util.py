...
rootSourcePath = r"/home/xuhexiang/data/BugT/Code"
rootTestPath = r"/home/xuhexiang/data/BugT/Test"
rootRunPath = r"/home/xuhexiang/data/BugT/Run"
rootPath = r"/home/xuhexiang/data/BugT/Run"
rootLibPath = r"/home/xuhexiang/data/BugT/Lib"
rootResultPath = r"/home/xuhexiang/data/BugT/Result"
rootCovPath = r"/home/xuhexiang/data/BugT/Cov"
rootMBFLCovPath = r"/home/xuhexiang/data/BugT/MBFLCov"
...
# rootPath = r"D:\software\OJexperiment\OJexperiment"
# rootPath = "/home/yudeli/OJexperiment"
...
def compileCfile(FilePath):
    resjudge = FilePath.split(".")[0]+".class"
    if os.path.exists(resjudge):
        os.remove(resjudge)
    cmd = "cd " + rootRunPath + " && javac "+(FilePath)
    flag = False
    try:
        os.system(cmd)
        resjudge = FilePath.split(".")[0]+".class"
