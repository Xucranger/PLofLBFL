...
def getInfo(temp_order, caseNum, res, mutateOutPutDir, programOutPutDir):
    ...
    for i in range(caseNum):
        ...
        if res[i] == False:
            ...
            if kill == False:
                Anf += 1
    return Akf, Anf, Akp, Anp, killInfo
...
def work(source, prename,testDataPath):
                    ...
                    if key in line:
                        for mutation_operator in value:
                            ...
                            while pos >= 0 and pos < linelen:
                                ...
                                Akf, Anf, Akp, Anp, killInfo = getInfo(temp_order, caseNum, res, mutateOutPutDir,
                                                             programOutPutDir)
                                print(line)
                                print(newline)
                                print(mutateOutPutDir)
                                print(programOutPutDir)
                                print(killInfo)
                                # print("over!")
                                # exit()
